...
export const PageHeader: React.FC<PageHeaderProps> = ({ 
  ...
  // Check if user is secretary or coordinator or director - case insensitive comparison
  const allowedRoles = ['COORDENADOR', 'SECRETARIO', 'DIRETOR'];
