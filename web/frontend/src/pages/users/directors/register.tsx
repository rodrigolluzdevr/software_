  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errorMessage = 'registro de diretor falhou, tente novamente';
          ...
          <div className="w-full px-2 sm:px-3 md:px-4 lg:px-6">
            <div className="py-4">
              <div className="shadow-sm rounded bg-white">
                <div className="p-5">
                  <h5 className="text-lg font-semibold">Cadastrar Diretor</h5>
                </div>
...
export default withAuth(DirectorRegister, ['SECRETARIO', 'COORDENADOR']);