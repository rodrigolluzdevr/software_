  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        let errorMessage = 'registro de coordenador falhou, tente novamente';
          ...
          <div className="w-full px-2 sm:px-3 md:px-4 lg:px-6">
            <div className="py-4">
              <div className="shadow-sm rounded bg-white">
                <div className="p-5">
                  <h5 className="text-lg font-semibold">Cadastrar Coordenador</h5>
                </div>
                    ...
                    <div className="grid grid-cols-6 gap-6 mb-6">
                      <div className="col-span-6 sm:col-span-1 lg:col-span-1 flex items-end">
                        <ToggleSwitch
                          ...
                          onChange={() =>
                            updateWorkInfo('isActive', !workInfo.isActive)
                          }
                        />
                      </div>
                    </div>
...
export default withAuth(CoordinatorRegister, ['SECRETARIO']);